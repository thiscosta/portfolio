  ...
  components: {
    ...
    MuiButton: {
      styleOverrides: {
        ...
        containedPrimary: {
          ...
          boxShadow: globalTheme.customShadows["Colors"]["Shadow Primary"].boxShadow, 
        ...
        containedSecondary: {
          ...
          boxShadow: globalTheme.customShadows["Colors"]["Shadow Secondary"].boxShadow, 
          color: `rgba(255, 255, 255, 1)`,  
          "&:hover": {
        ...
        containedError: {
          backgroundColor: globalTheme.palette["Error"]["Main"], 
          boxShadow: globalTheme.customShadows["Colors"]["Shadow Error"].boxShadow, 
          color: `rgba(255, 255, 255, 1)`,  
          "&:hover": {
        ...
        containedSuccess: {
          backgroundColor: globalTheme.palette["Success"]["Main"], 
          boxShadow: globalTheme.customShadows["Colors"]["Shadow Success"].boxShadow, 
          color: `rgba(255, 255, 255, 1)`,  
          "&:hover": {
        ...
        containedInfo: {
          backgroundColor: globalTheme.palette["Info"]["Main"], 
          boxShadow: globalTheme.customShadows["Colors"]["Shadow Info"].boxShadow, 
          color: `rgba(255, 255, 255, 1)`,  
          "&:hover": {
        ...
        containedWarning: {
          backgroundColor: globalTheme.palette["Warning"]["Main"], 
          boxShadow: globalTheme.customShadows["Colors"]["Shadow Warning"].boxShadow, 
          color: `rgba(255, 255, 255, 1)`,  
          "&:hover": {
        ...
        textInfo: {
          ...
          "&:hover": {
            backgroundColor: globalTheme.palette["Text"]["Primary Shades"]["4p"], 
            color: `rgba(0, 0, 0, 0.87)`,  
          }, 
          "&:disabled": {
            border: `1px solid globalTheme.customShadows["Light"]["Action"]["Disabled Background (12p)"].color`, 
        ...
        outlinedSecondary: {
          border: `1px solid globalTheme.customShadows["Light"]["Secondary"]["Shades"]["50p"].color`, 
          boxSizing: `border-box`, 
          color: `rgba(2, 122, 209, 1)`,  
          "&:hover": {
            backgroundColor: globalTheme.palette["Secondary"]["Shades"]["4p"], 
        ...
        outlinedError: {
          border: `1px solid globalTheme.customShadows["Light"]["Error"]["Shades"]["50p"].color`, 
          boxSizing: `border-box`, 
          color: `rgba(233, 78, 124, 1)`,  
          "&:hover": {
            backgroundColor: globalTheme.palette["Error"]["Shades"]["4p"], 
        ...
        outlinedSuccess: {
          border: `1px solid globalTheme.customShadows["Light"]["Success"]["Shades"]["50p"].color`, 
          boxSizing: `border-box`, 
          color: `rgba(100, 207, 111, 1)`,  
          "&:hover": {
            backgroundColor: globalTheme.palette["Success"]["Shades"]["4p"], 
        ...
        outlinedInfo: {
          border: `1px solid globalTheme.customShadows["Light"]["Info"]["Shades"]["50p"].color`, 
          boxSizing: `border-box`, 
        ...
        outlinedWarning: {
          border: `1px solid globalTheme.customShadows["Light"]["Warning"]["Shades"]["50p"].color`, 
          boxSizing: `border-box`, 
          color: `rgba(255, 138, 30, 1)`,  
          "&:hover": {
            backgroundColor: globalTheme.palette["Warning"]["Shades"]["4p"], 
    ...
    MuiFormControlLabel: {
      styleOverrides: {
        "label": {
          ...
          fontFamily: globalTheme.typography["Typography"]["Body 2"].fontFamily, 
          fontWeight: globalTheme.typography["Typography"]["Body 2"].fontWeight, 
          fontSize: globalTheme.typography["Typography"]["Body 2"].fontSize, 
          letterSpacing: globalTheme.typography["Typography"]["Body 2"].letterSpacing, 
          textDecoration: globalTheme.typography["Typography"]["Body 2"].textDecoration, 
          lineHeight: globalTheme.typography["Typography"]["Body 2"].lineHeight, 
          textTransform: globalTheme.typography["Typography"]["Body 2"].textTransform, 
          "&.Mui-disabled": {
    ...
    MuiSwitch: {
      styleOverrides: {
        root: {
          "&:hover": {
            backgroundColor: globalTheme.palette["Action"]["Hover (4p)"], 
            borderRadius: `100px`, 
          }
        },
        thumb: {
