...
const DeleteWorkspace1 = styled("div")({  
  textAlign: `left`,  
  whiteSpace: `pre-wrap`,  
...
const NovaBeer = styled("div")(({ theme }) =>({  
  textAlign: `left`,  
  whiteSpace: `pre-wrap`,  
...
function DeleteWorkspace(props) {
  const {data, fns} = useDeleteWorkspace();
  return (
    <Property1Default >
       <Top >
         <Top1 >
...
ALL Apps & Components within the Workspace`}
                         </Description>
                   </Text>
                 </UnstyledAlert>
               </AlertOutlined>
       ...
       <TextFieldStandard variant="standard" size="small"  onChange={fns.onDeleteWorkspaceChange} onBlur={fns.onDeleteWorkspaceBlur} label={`Type DELETE here`} helperText={data.deleteWorkspaceError} value={data.deleteWorkspaceValue} error={Boolean(data.deleteWorkspaceError)}   />
       <Btns >
         <ButtonText variant="text" size="medium" color="info"  onClick={props.onClose}  > Cancel </ButtonText>
         <ButtonContained variant="contained" size="medium" color="primary"  onClick={() => fns.deleteWs(props.wsTeam)} loading={data.processingStatus === "In process"}  > Delete Workspace </ButtonContained>
       </Btns>
     </Property1Default>
   );
}
