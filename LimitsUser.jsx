...
import useLimitsUser from './useLimitsUser';
...
const Frame811 = styled("div", {
  ...
  padding: `0px`,  
  boxSizing: `border-box`,  
  margin: data.currentPlan === 15 ? `0px` : data.currentPlan === 18
 ? `0px` : `0px 0px 0px 93px`,  
}));
...
function LimitsUser(props) {
  const {data, fns} = useLimitsUser();
  return (
    <LimitsProMonthly >
       <TopWarning >
         <Warning >
       ...
       <TopSec >
         <Top >
           ...
           {(!(data.currentPlan === 15) && !(data.currentPlan === 18
               ...
               <ProPrice >
               {data.currentPlan === 17 ? `$49/mo per workspace user` : data.currentPlan === 15 ? `$49/mo per workspace user` : data.currentPlan === 18
 ? `$49/mo per workspace user` :  `$58/mo per workspace user`}
                 </ProPrice>
           }
           {((data.currentPlan === 15) || (data.currentPlan === 18
)) &&
               <TeamPrice >
               {data.currentPlan === 18
 ? `$93/mo per workspace user` :  `$79/mo per workspace user`}
                 </TeamPrice>
           }
         </Top>
         {(!(data.currentPlan === 15) && !(data.currentPlan === 18
       ...
       <Frame82 >
         {(!(data.currentPlan === 15) && !(data.currentPlan === 18
             ...
             <Frame62 >
               <TeamPrice1 >
                 {data.currentPlan === 17 ? `$79/mo per workspace user` : data.currentPlan === 15 ? `$79/mo per workspace user` : data.currentPlan === 18
 ? `$79/mo per workspace user` :  `$93/mo per workspace user`}
                   </TeamPrice1>
               <UpgradeTo >
                 {`Upgrade to`}
                   </UpgradeTo>
